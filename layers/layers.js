...
var lyr_poligonos_zonas_frecuenciadas_v70_muestra_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/poligonos_zonas_frecuenciadas_v70_muestra_1_3.png" /> 4 - 6<br />\
    <img src="styles/legend/poligonos_zonas_frecuenciadas_v70_muestra_1_4.png" /> 6 - 12<br />'
        });
...
lyr_poligonos_zonas_frecuenciadas_v70_muestra_1.set('fieldAliases', {'locality': 'locality', 'zonificacion': 'zonificacion', 'station_code': 'station_code', 'LT_teorico': 'LT_teorico', 'LT_actual': 'LT_actual', 'LT_teorico_readjs': 'LT_teorico_readjs', });
lyr_poligonos_zonas_frecuenciadas_v70_muestra_1.set('fieldImages', {'locality': 'TextEdit', 'zonificacion': 'TextEdit', 'station_code': 'TextEdit', 'LT_teorico': 'Range', 'LT_actual': 'Range', 'LT_teorico_readjs': 'Range', });
lyr_poligonos_zonas_frecuenciadas_v70_muestra_1.set('fieldLabels', {'locality': 'header label', 'zonificacion': 'header label', 'station_code': 'header label', 'LT_teorico': 'header label', 'LT_actual': 'header label', 'LT_teorico_readjs': 'header label', });
